...
$txt.=' The creatures currently alive are :- '.json_encode($c);
 ...
 $header=Array('Content-Type: application/json','anthropic-version: 2023-06-01','x-api-key: sk-ant-api03-AAA');
    $messages = Array(Array('role' => 'user', 'content' => $txt));
    $data=Array('model' => 'claude-3-opus-20240229', 'max_tokens' => 1024, 'messages' => $messages);
